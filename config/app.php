...
define('TIME_HOUR', 3600); //1小时的秒数
define('TIME_30_MIN', 1800); //30分钟的秒数
define('TIME_15_MIN', 900); //15分钟的秒数
...
$config = [
     ...
     */
    'rewrite_route' => [
        '/demo/index/{id}' => '/demo/index/id/{id}',
    ],
    //用户默认头像
...
//    'after_controller' => ['hook_header_setter'],
     ...
     * 官网首页，用于头部Logo的链接
     * */
    'website_index' => 'http://www.ylphp.com',

    /*
     * 用户中心的相关配置
     * */
    'user_center' => [
        'host' => 'http://passport.ylphp.com', //用户中心的访问域名
 ...
 */
//return array_merge($config, require('/data/config/manage.yiluphp.com/config.php'));
return $config;