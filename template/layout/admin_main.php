...
<nav class="navbar navbar-expand-sm navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    <a class="navbar-brand col-md-2" href="/"><img src="<?php echo YiluPHP::I()->lang('website_logo_img'); ?>" height="35"></a>
            ...
            foreach($layout_menus_list as $menu):
                ...
                <li class="nav-item
                    ...
                    if ($menu['href'] && $menu['type']=='SYSTEM'){
                        $url = (strpos($menu['href'],'http')===0?'':$config['user_center']['host']).$menu['href'];
                    }
                    else{
                        $url = $menu['href'];
                    }
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown03">
                        <?php foreach($menu['children'] as $child): ?>
                            ...
                            if ($child['href'] && $child['type']=='SYSTEM'){
                                $url = (strpos($child['href'],'http')===0?'':$config['user_center']['host']).$child['href'];
                            }
                            else{
                                $url = $child['href'];
                            }
